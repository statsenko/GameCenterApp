...
public class FLExampleListner : MonoBehaviour {
	...
	void Start () {
		FLButtonExample.instance.addEventListener(BaseEvent.CLICK, onButtonClick);
		FLButtonExample.instance.addEventListener(BaseEvent.CLICK, onButtonClickData);
	}
