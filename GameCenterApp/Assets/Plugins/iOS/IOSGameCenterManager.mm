    ...
    if(board != nil) {
        ...
        [board loadScoresWithCompletionHandler: ^(NSArray *scores, NSError *error) {
            if (error != nil) {
                ...
                UnitySendMessage("GameCenterManager", "onLeaderBoardScoreListLoadFailed", [Unity3d NSStringToChar:@""]);
                return;
            ...
            if (scores != nil) {
                ...
                NSString *str = [[data copy] autorelease];
                UnitySendMessage("GameCenterManager", "onLeaderBoardScoreListLoaded", [Unity3d NSStringToChar:str]);
...
-(void) loadUserData:(NSString *)uid {
    ...
    [GKPlayer loadPlayersForIdentifiers:playerIdArray withCompletionHandler:^(NSArray *players, NSError *error) {
        ...
        if (error != nil) {
            ...
            UnitySendMessage("GameCenterManager", "onUserInfoLoadFailed", [Unity3d NSStringToChar:player.playerID]);
            return;
        }
        ...
        [player loadPhotoForSize:GKPhotoSizeSmall withCompletionHandler:^(UIImage *photo, NSError *error) {
                ...
                NSString *str = [[data copy] autorelease];
                UnitySendMessage("GameCenterManager", "onUserInfoLoaded", [Unity3d NSStringToChar:str]);
    ...
    if (leaderboardRequest != nil) {
        ...
        [leaderboardRequest loadScoresWithCompletionHandler:^(NSArray *scores, NSError *error){
            if (error != nil) {
                ...
                [leaderboardRequest.localPlayerScore issueChallengeToPlayers:playerIdArray message:message];
...
extern "C" {
    ...
    void _showLeaderBoard(char* leaderBoradrId, int scope) {
        [GCManager showLeaderBoard:[Unity3d charToNSString:leaderBoradrId] scope:scope];
    }
    ...
    void _getLeadrBoardScore(char* leaderBoradrId, int scope) {
        [GCManager retrieveScoreForLocalPlayerWithCategory:[Unity3d charToNSString:leaderBoradrId] scope:scope];
    }
    
    void _loadLeadrBoardScore(char* leaderBoradrId, int scope, int collection, int from, int to) {
        [GCManager retriveScores:[Unity3d charToNSString:leaderBoradrId] scope:scope  collection: collection from:from to:to];
    }
    ...
    void _sendChallenge(char* leaderBoradrId, char* message, char* playerId) {
        [GCManager sendChallenge:[Unity3d charToNSString:leaderBoradrId] message:[Unity3d charToNSString:message] playerId:[Unity3d charToNSString:playerId]];
    }
    ...
    void _loadGCUserData(char* uid) {
        [GCManager loadUserData:[Unity3d charToNSString:uid]];
    }
